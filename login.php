...
<html lang="en">
  <head>
  	<title>Sign In - Woltz | Store</title>
    <meta charset="utf-8">
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<h3 class="mb-4 text-center"> Already have an account?</h3>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
	            ...
	            <div class="form-group">
	             ...
	             id="password-field" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>">
